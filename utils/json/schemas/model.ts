...
export type PropertyNameSchema =
  | 'id'
  | 'createdAt'
  | 'updatedAt'
  | 'deletedAt'
...
export type ModelSchema = {
  properties?: Record<PropertyNameSchema, PropertySchema>;
  relations?: Record<PropertyNameSchema, RelationPropertySchema>;
  uniques?: PropertyNameSchema[];
};
...
export type CommonPropertySchema = {
...
export type PropertySchema = CommonPropertySchema &
  (
