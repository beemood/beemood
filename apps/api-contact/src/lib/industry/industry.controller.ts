...
import {
  CreateIndustryDto as CreateDto,
  ReadIndustryDto as ReadDto,
  UpdateIndustryDto as UpdateDto,
} from './dto/industry.dto.js';
import {
  IndustryFindManyArgsDto as FindManyDto,
  IndustryFindOneArgsDto as FindOneDto,
  IndustrySelectArgsDto as SelectDto,
} from './dto/query-industry.dto.js';

@ResourceController('industry', [
  CreateDto,
  UpdateDto,
  SelectDto,
  FindOneDto,
...
export class IndustryController {
  constructor(
    @InjectRepo('industry') protected readonly repo: P.IndustryDelegate
  ) {}
