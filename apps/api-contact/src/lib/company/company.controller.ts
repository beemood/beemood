...
import {
  CreateCompanyDto as CreateDto,
  ReadCompanyDto as ReadDto,
  UpdateCompanyDto as UpdateDto,
} from './dto/company.dto.js';
import {
  CompanyFindManyArgsDto as FindManyDto,
  CompanyFindOneArgsDto as FindOneDto,
  CompanySelectArgsDto as SelectDto,
} from './dto/query-company.dto.js';

@ResourceController('company', [
  CreateDto,
  UpdateDto,
  SelectDto,
  FindOneDto,
...
export class CompanyController {
  constructor(
    @InjectRepo('company') protected readonly repo: P.CompanyDelegate
  ) {}
